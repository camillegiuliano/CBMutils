...
#' @param cumPoolsRaw Data.table with a numeric column called `age`` and
#'   columns called `colsToUse`.
...
#'
#' @return #' A `data.table` with original columns plus new columns named `colsToUseNew``.
#'
